...
The goal of chapter2.regexcite is to make regular expressions more
...
You can install the development version of chapter2.regexcite from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("tricktracktriu/toy.package")
```
...
That’s exactly what `chapter2.regexcite::str_split_one()` and
`chapter2.regexcite::strsplit1()` do.

``` r
library(chapter2.regexcite)
