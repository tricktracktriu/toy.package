...
The goal of chapter2.regexcite is to  make regular expressions more exciting!
...
You can install the development version of chapter2.regexcite from [GitHub](https://github.com/) with:
...
That's exactly what `chapter2.regexcite::str_split_one()` and `chapter2.regexcite::strsplit1()` do.
